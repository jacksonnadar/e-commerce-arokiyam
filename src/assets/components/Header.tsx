        ...
        <nav>
            <section className="section-1">
                ...
                <ul className="nav-links">
                    <a><li className="nav-link active">Home</li></a>
                    <a><li className="nav-link">Products</li></a>
                    <a><li className="nav-link">About us</li></a>
                    <a><li className="nav-link">Contact</li></a>
                    <a><li className="nav-link">Locations</li></a>
                </ul>
            </section>
